...
namespace APISICA.Controllers
{
    ...
    public class RecibirController : ControllerBase
    {
        ...
        public IActionResult AgregarRecibir(Class.JsonToken jsontoken)
        {
            ...
            string strSQL = "INSERT INTO ADMIN.INVENTARIO_GENERAL (NUMERO_DE_CAJA, ID_DEPARTAMENTO_FK, ID_DOCUMENTO_FK, FECHA_DESDE, FECHA_HASTA, DESCRIPCION_1, DESCRIPCION_2, DESCRIPCION_3, DESCRIPCION_4, DESCRIPCION_5, DESC_CONCAT, FECHA_POSEE, ID_USUARIO_POSEE, ID_ESTADO_FK, FECHA_REGISTRA, ID_USUARIO_REGISTRA, EXPEDIENTE)";
            strSQL += " VALUES (";
